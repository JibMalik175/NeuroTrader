...
export const CONFIG = {
  ...
  // above it. canOpenPosition() hard-blocks any value != 1 until that
  // handling exists. Do not raise this to "win more"; raise it only after
  // implementing liquidation awareness (see Freqtrade ft_stoploss_reached).
